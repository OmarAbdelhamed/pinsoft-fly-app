...
const PaymentScreen = () => {
  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <form
        className='w-full max-w-lg p-8 border shadow-xl  rounded-lg'
        ...
        <div className='flex justify-between mb-8 '>
          <div
            className={`payment-option ${
              ...
              paymentOption === 'card' ? 'bg-primary-color-extra-light text-white' : 'bg-transparent'
            }`}
          ...
          <div
            className={`payment-option ${
              ...
              paymentOption === 'transfer' ? 'bg-primary-color-extra-light text-white' : 'bg-transparent'
            }`}
          ...
          <div
            className={`payment-option ${
              ...
              paymentOption === 'papara' ? 'bg-primary-color-extra-light text-white' : 'bg-transparent'
            }`}
            ...
            <div className='card-details-row'>
              ...
              <div className='card-details-item'>
                ...
                <input
                  ...
                  className='border text-3xl border-gray-300 rounded-lg p-2 w-[100px]'
                />
              </div>
            </div>
          </div>
